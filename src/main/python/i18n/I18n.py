...
_translations_en = {
    ...
    'GUI.PHASE.INPUT.HINT': 'Hint: Alternatively, you can simply drag\'n\'drop images to "Selected images".',
    'GUI.PHASE.INPUT.SELECTED_IMAGES': 'Selected images',
    'GUI.PHASE.INPUT.SELECTED_IMAGES.HINT': 'The images can be sorted via drag\'n\'drop.',
...
_translations_de = {
    ...
    'GUI.PHASE.INPUT.HINT': 'Tip: Bilder können alternativ einfach per Drag\'n\'Drop auf "Ausgewählte Bilder" gezogen werden.',
    'GUI.PHASE.INPUT.SELECTED_IMAGES': 'Ausgewählte Bilder',
    'GUI.PHASE.INPUT.SELECTED_IMAGES.HINT': 'Die Bilder können per Drag\'n\'Drop sortiert werden.',
